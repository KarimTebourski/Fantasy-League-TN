...
class InternetAsync {
  ...
  Future<User> fetchUser(context, username, password) async {
    ...
    try {
      ...
      response = await http.post(
          "http://192.168.1.8:4000/users/login",
  ...
  fetchTeams(context) async {
    ...
    try {
      response = await http
          .get("http://192.168.1.8:4000/teams/select_all");
      if (response.statusCode == 200) {
  ...
  Future addTeam(context, Team team) async {
    ...
    try {
      ...
      var url = "http://192.168.1.8:4000/teams/add_team"; // iOS
      ...
      if (response.statusCode == 200) {
        ...
        try {
          response1 = await http.get("http://192.168.1.8:4000/teams/last_id");
          ...
          if (response1.statusCode == 200){
            ...
            response2 = await http.post("http://192.168.1.8:4000/teams/affecteteamauuser",
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
  ...
  addUser(context, String username, String email, String password) async {
    ...
    try {
      response = await http.post(
          "http://192.168.1.8:4000/users/checkNameEmail",
          headers: {'Content-Type': 'application/x-www-form-urlencoded'},
  ...
  addUserToDB(context, String username, String email, String password) async {
    ...
    try {
      response = await http.post(
          "http://192.168.1.8:4000/users/register",
          headers: {'Content-Type': 'application/x-www-form-urlencoded'},
